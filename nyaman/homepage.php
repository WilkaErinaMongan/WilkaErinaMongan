...
<div class="card-group">
  <div class="card">
  <img src="cafemanalagi.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
	  <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 8';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 8';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
<div class="card-group">
  <div class="card">
  <img src="miesetang.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
	  <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 18';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 18';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
?> 
  ...
  <div class="card">
  <img src="cbes.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 19';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 19';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
?> 
  ...
  <div class="card">
  <img src="buburayam.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 17';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<br><br>
 <?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 17';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
