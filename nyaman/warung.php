...
<head>
	...
	<style>
        ...
        .content {
            background-image: url('assets/img/warung.png');
...
<div class="card-group">
  <div class="card">
  <img src="wrsetia.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
<?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 14';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 14';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
?> 
  ...
  <div class="card">
  <img src="wrkirana.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 13';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 13';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
?> 
  ...
  <div class="card">
  <img src="wrblessing.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 12';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<br><br>
 <?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 12';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
