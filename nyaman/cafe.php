...
<head>
	...
	<style>
        ...
        .content {
            background-image: url('assets/img/gudeg.png');
...
?> 
  ...
  <div class="card">
  <img src="cafesuke.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 9';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 9';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
...
?> 
  ...
  <div class="card">
  <img src="cafelogika.PNG" class="card-img-top" height="400px">
    <div class="card-body">
      <h5 class="card-title">
      <?php
include "../koneksi.php";
$tampildata = 'SELECT judul FROM makanan WHERE id = 10';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['judul'].'</td>';
...
<br><br>
 <?php
include "../koneksi.php";
$tampildata = 'SELECT info FROM makanan WHERE id = 10';
$query = mysqli_query($koneksi, $tampildata);
while ($row = mysqli_fetch_array($query))
{
    echo '<td>'. $row ['info'].'</td>';
